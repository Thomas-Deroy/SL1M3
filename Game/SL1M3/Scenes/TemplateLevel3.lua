...
function TemplateLevel3.load()
    ...
    background:addComponent("renderer", SpriteComponent.new("SL1M3/Assets/background_level3.png", 1, 1))
    ...
    foreground:addComponent("renderer", SpriteComponent.new("SL1M3/Assets/foreground_level3.png", 1, 1))
    table.insert(gameObjects, foreground)


    -- Player
    player = GameObject.new(2180, 1200)
    ...
    -- Platforms
    CreatePlatform(2090, 1270, 1)
    CreatePlatform(1700, 1285, 2, { isFloating = true })
    CreatePlatform(1290, 1260, 2, { isFloating = true })
    CreatePlatform(960, 1160, 3)
    CreatePlatform(555, 1290, 2, { isFloating = true })
    CreatePlatform(200, 1200, 5)
    CreatePlatform(360, 850, 3)
    CreatePlatform(610, 810, 1)
    CreatePlatform(980, 825, 1)
    CreatePlatform(1320, 690, 5)
    CreatePlatform(1140, 430, 5)
    CreatePlatform(1340, 170, 3)
    CreatePlatform(1030, 260, 1)
    CreatePlatform(810, 375, 5)
    CreatePlatform(540, 240, 1)
    CreatePlatform(320, 260, 6)
    CreatePlatform(2330, 180, 6)
    CreatePlatform(2050, 170, 3)
    
    -- Exit platform
    LevelBuilder.createPlatform(world, gameObjects, pendingPortals, player, 1770, 40, 4)
...
function TemplateLevel3.unload()
    EffectManager.clear()
end

function TemplateLevel3.update(dt)
    -- Sync music state
    GameState.tickMusic()
