...
function TemplateLevel1.load()
    ...
    background:addComponent("renderer", SpriteComponent.new("SL1M3/Assets/background_level1.png", 1, 1))
    ...
    foreground:addComponent("renderer", SpriteComponent.new("SL1M3/Assets/foreground_level1.png", 1, 1))
    table.insert(gameObjects, foreground)


    -- Player
    player = GameObject.new(1260, 1250)
    ...
    -- Platforms
    CreatePlatform(1170, 1295, 1)
    CreatePlatform(860, 1255, 1, { isFloating = true })
    CreatePlatform(1515, 1260, 2, { isFloating = true })
    CreatePlatform(1800, 990, 3)
    CreatePlatform(600, 1200, 5)
    CreatePlatform(1550, 890, 3)
    CreatePlatform(1250, 860, 1)
    CreatePlatform(700, 860, 2, { isFloating = true })
    CreatePlatform(480, 850, 3)
    CreatePlatform(970, 820, 6)
    CreatePlatform(200, 800, 5)
    CreatePlatform(2200, 300, 6)
    CreatePlatform(400, 480, 3)
    CreatePlatform(1960, 320, 3)
    CreatePlatform(670, 380, 2, { isFloating = true })
    CreatePlatform(1700, 500, 5)
    CreatePlatform(1000, 150, 3)
    CreatePlatform(1450, 150, 3)

    -- Exit platform
    LevelBuilder.createPlatform(world, gameObjects, pendingPortals, player, 1200, 170, 4)
...
function TemplateLevel1.unload()
    EffectManager.clear()
end

function TemplateLevel1.update(dt)
    -- Sync music state
    GameState.tickMusic()
